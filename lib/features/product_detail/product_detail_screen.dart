...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  ///
  void addToCart() => productDetailsService.addToCart(context: context, product: widget.product);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.all(8), child: Text(widget.product.description)),
            Container(color: Colors.black12, height: 5),
            Padding(
